...
```
#############################################################################################
why do you have ncol=2 instead of 1? Should only start with 1 col of 0's not two?????
#############################################################################################
If not its not hard to change the function below to add another col of 0's 
